...
### Plot distributions
    ...
    mkPlot.py --inputFile histos_WW_full_Run2.root

    mkPlot.py --inputFile histos_WW_full_Run2.root --onlyPlot cratio --showIntegralLegend 1 --fileFormats png
    mkPlot.py --inputFile histos_WW_full_Run2.root --onlyPlot cratio --showIntegralLegend 1 --fileFormats png  --plotNormalizedDistributions
